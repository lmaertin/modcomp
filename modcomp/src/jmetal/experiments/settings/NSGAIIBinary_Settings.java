...
public class NSGAIIBinary_Settings extends Settings {
  ...
  public NSGAIIBinary_Settings(String problem, FeatureModel featureModel, HashSet<String> faultyFeatures) {
	  super(problem) ;

	  Object [] problemParams = {"Binary",featureModel, faultyFeatures};
	  try {
		  problem_ = (new ProblemFactory()).getProblem(problemName_, problemParams);
	  } catch (JMException e) {
		  e.printStackTrace();
	  ...
	  maxEvaluations_ = populationSize_ * iterations;  
	  System.out.println("popsize: " + populationSize_ + ", iterations: " + iterations + " (max. " + maxEvaluations_ + " evals)");
